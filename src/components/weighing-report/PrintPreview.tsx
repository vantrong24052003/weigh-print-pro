  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 backdrop-blur-md">
      <div className="bg-white rounded-3xl shadow-2xl max-w-[420px] w-full overflow-hidden flex flex-col max-h-[95vh]">
        ...
        <div className="bg-slate-950 px-6 py-1 overflow-x-auto">
          <pre style={{ fontFamily: 'monospace', fontSize: '7.5px', lineHeight: 1.4, color: '#475569', userSelect: 'none' }}>
            {'|' + '1234567890'.repeat(3) + '12' + '|'}
          </pre>
        </div>
        ...
        <div className="p-6 flex flex-col gap-3 bg-white border-t border-slate-100">
          <button
            onClick={onQzPrint}
            className="w-full h-12 bg-amber-500 text-white rounded-2xl text-xs font-bold hover:bg-amber-600 transition-all active:scale-95 shadow-lg shadow-amber-200 uppercase tracking-widest"
          >
            In (QZ Tray)
          </button>
          <button
